...
from paddleseglibs.paddleseg.utils import logger, seg_env
from paddleseglibs.paddleseg.utils.download import download_file_and_uncompress
        ...
        if urlparse(pretrained_model).netloc:
            ...
            with generate_tempdir() as _dir:
                with filelock.FileLock(
                    ...
                    # pretrained_model = 'pretrained_model/mix_vision_transformer_b5'
