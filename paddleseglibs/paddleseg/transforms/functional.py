...
def denoise(im, param1, param2, param3, param4):
    im = np.uint8(im)
    im = cv2.fastNlMeansDenoisingColored(im,None,param1,param2,param3,param4)
    im = np.float32(im)
    return im
    
def autocontrast(image, clip_hist_percent=1):
